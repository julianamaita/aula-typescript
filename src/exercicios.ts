// Exercicíos referentes a aula: 07/03/2025 - 
...
repo.salvar({ nome: "Juliana", email: "juliana@email.com" });
repo.salvar({ nome: "Luana", email: "luana@email.com" });
